     ...
     <div id="appHome" v-cloak>
      ...
      <div id="side-bar">
         <div class="user-menu-btn am-show-sm" style="position:fixed;bottom: 50px;right: 25px;">
             <a href="#user-side-menu-bar" data-am-offcanvas :class="{ 'mark' : getUserMessage+getWebMessage >0}" class="am-icon-btn am-icon-bars" style="background: #0e90d2;color:#fff;"><sup></sup></a>
          </div>
